...
void esp8266_proc()
{
  ...
  if(uart6_rec_tick>10)
  {
    ...
    u8 temp2_string[]="AT+MQTTPUB=0,\"$sys/ij02LHn7yu/ch32/thing/property/post\",\"{\\\"id\\\":\\\"123\\\"\\,\\\"params\\\":{\\\"appkey\\\":{\\\"value\\\":0}}}\",0,0\r\n";
    switch(appkey)
    {
        case 1:
            lock_flag = 0;
        ...
        case 3:
            ...
            u8 temp_string[] = "AT+MQTTPUB=0,\"$sys/ij02LHn7yu/ch32/thing/property/post\",\"{\\\"id\\\":\\\"123\\\"\\,\\\"params\\\":{\\\"appkey\\\":{\\\"value\\\":6}}}\",0,0\r\n";
            uart6_send_string(temp_string,sizeof(temp_string)-1);
            break;
        case 4:
            audio_volume(appstring);
            u8 temp3_string[] = "AT+MQTTPUB=0,\"$sys/ij02LHn7yu/ch32/thing/property/post\",\"{\\\"id\\\":\\\"123\\\"\\,\\\"params\\\":{\\\"appkey\\\":{\\\"value\\\":7}}}\",0,0\r\n";
